...
export default function Pricing() {
  ...
  return (
    <div className="px-10 lg:px-20">
              ...
              <div className="flex items-center gap-3 justify-center lg:justify-end">
                ...
                <button
                  ...
                  className={`px-4 md:px-6 py-2 md:py-3 rounded-lg font-medium text-sm md:text-base transition-all cursor-pointer ${billingPeriod === "monthly"
                      ...
                      : "bg-midnight-monarch text-white border border-midnight-monarch"
                    }`}
                >
                  Monthly
                </button>
      ...
      <RevealOnScroll delay={0.1}>
        <div className="mb-20 bg-white px-4 md:px-8 lg:px-12 rounded-2xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {/* Starter Plan */}
            <div className="bg-midnight-monarch border border-gray-800 rounded-2xl p-6 lg:p-8 flex flex-col text-white">
            ...
            {/* Accelerate Plan */}
            <div className="bg-midnight-monarch border border-gray-800 border-l-purplish-blue rounded-2xl p-6 lg:p-8 flex flex-col text-white">
